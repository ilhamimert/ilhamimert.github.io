...
const araclar = [
  ...
  {
    id: 8,
    baslik: "Honda Civic 1.5 Turbo",
    kategori: "sedan-suv",
    resim: "https://images.unsplash.com/photo-1606152421802-db97b9c7a11b?w=800&q=80",
    yil: 2022,
    km: "67.000 km",
    aciklama: "Otomatik, Benzin, Kırmızı, Hasar Kayıtsız. Spor paket, geri görüş kamerası.",
  },
  {
    id: 9,
    baslik: "Skoda Octavia 2.0 TDI",
    kategori: "sedan-suv",
    resim: "https://images.unsplash.com/photo-1617531653332-bd46c16f4d68?w=800&q=80",
    yil: 2021,
    km: "112.000 km",
    aciklama: "Otomatik, Dizel, Mavi, Hasar Kayıtsız. Geniş bagaj, tam donanım.",
  },
  {
    id: 10,
    baslik: "Range Rover Sport",
